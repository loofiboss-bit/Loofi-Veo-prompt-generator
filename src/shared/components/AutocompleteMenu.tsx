...
const AutocompleteMenu: React.FC<AutocompleteMenuProps> = ({ items, position, onSelect, onClose }) => {
    ...
    return (
        ...
        >
            ...
            {items.map((item, index) => (
                ...
                >
                    <div className={`mt-0.5 p-1.5 rounded-full ${item.type === 'character' ? 'bg-fuchsia-500/20 text-fuchsia-400' : 'bg-emerald-500/20 text-emerald-400'}`}>
