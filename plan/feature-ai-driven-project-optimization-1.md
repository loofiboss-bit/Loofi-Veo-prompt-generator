...
| Task     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Completed | Date |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- | ---- |
| TASK-014 | Create `src/core/services/costEstimationService.ts` — Singleton service. Public methods: `estimatePrompt(promptId: string, state: PromptState, modelId: 'veo' \| 'sora'): CostEstimate` (synchronous: calculates quality score 1-10 using existing `calculatePromptQuality` from `@core/utils/promptScoring` — maps 0-100 score to 1-10 scale, estimates cost using `estimateTextCost`/`estimateVideoCost` from `@core/constants/pricing`, builds `CostEstimate` with breakdown), `estimateProject(prompts: Array<{ id: string; state: PromptState }>, modelId: 'veo' \| 'sora'): { perPrompt: CostEstimate[], totalUsd: number, averageQuality: number }` (batch estimation), `getTradeoff(promptId: string, originalState: PromptState, improvedState: PromptState, modelId: 'veo' \| 'sora'): { costDelta: number, qualityDelta: number }` (compare before/after). Stores results in `useOptimizationStore` via `setCostEstimate` |           |      |
...
- **Description**: As a professional creator, I want cost estimates for both Veo and Sora.
