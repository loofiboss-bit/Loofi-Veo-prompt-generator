                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-3">
                                    {EXPORT_PROFILES.map(profile => (
                                        ...
                                        >
                                            <div className={`mt-1 mr-3 p-1 rounded-full ${selectedProfileId === profile.id ? 'bg-cyan-500 text-slate-900' : 'bg-slate-700 text-slate-400'}`}>
                                                {selectedProfileId === profile.id && <Icon name="check" className="w-3 h-3" />}
                                            </div>
                                            <div>
                                                <div className={`font-bold text-sm ${selectedProfileId === profile.id ? 'text-cyan-300' : 'text-slate-200'}`}>
                                                    {profile.label}
                                                </div>
