...
export const appUIStrings: any = {
    en: {
        ...
        tooltips: {
            ...
            useImageAsCameo: "When checked, this image will be used as a character reference for consistent appearance in Sora 2 emulation mode. The AI will be instructed to maintain the character's look.",
            characterCameoTag: "A unique tag or name (like @loofigasoline) to identify the character from the uploaded image. The AI will be instructed to maintain this character's likeness when you use this tag in the prompt.",
        ...
        fieldLabels: {
            ...
            characterCameoTag: "Character Cameo Tag",
