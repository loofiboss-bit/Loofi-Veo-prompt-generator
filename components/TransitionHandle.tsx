...
import { analyzeCut, TransitionRecommendation } from '../services/transitionAnalyst';
...
const TransitionHandle: React.FC<TransitionHandleProps> = ({ 
    transition, onUpdate, left, zoomLevel, incomingClipId, outgoingClipId 
}) => {
                        ...
                        {isAnalyzing ? (
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-[10px] font-bold text-cyan-300 uppercase">AI Suggestion</span>
                                </div>
                                <div className="text-xs font-bold text-white mb-1">
                                    {recommendation.type === 'cut' ? 'Hard Cut' : recommendation.type === 'dissolve' ? 'Cross Dissolve' : 'Dip to Black'}
                                </div>
