...
export const RESTRICTED_KEYWORDS = ['gore', 'violence', 'nsfw', 'hate speech'];
...
export const getArtStyles = (lang: Language): SelectOption[] => {
  const styles: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Gorilla Viral Style': {
      en: 'Gorilla Viral Style',
      sv: 'Gorilla Viral-stil',
      es: 'Estilo Viral Gorila',
      fr: 'Style Viral Gorille',
      de: 'Gorilla Viral-Stil',
    },
    'Documentary Style': {
      en: 'Documentary Style',
      sv: 'Dokumentärstil',
      es: 'Estilo Documental',
      fr: 'Style Documentaire',
      de: 'Dokumentarstil',
    },
    'Found Footage': {
      en: 'Found Footage',
    ...
    '2D Cel Animation': {
      ...
      sv: '2D Cel-animation',
      es: 'Animación Cel 2D',
      fr: 'Animation 2D (Cellulo)',
      de: '2D-Cel-Animation',
    },
    '3D Rendered (Pixar-like)': {
      en: '3D Rendered (Pixar-like)',
      sv: '3D-renderad (Pixar-liknande)',
      es: 'Renderizado 3D (tipo Pixar)',
      fr: 'Rendu 3D (style Pixar)',
      de: '3D-gerendert (Pixar-ähnlich)',
    },
    'Vector Animation': {
      en: 'Vector Animation',
      sv: 'Vektoranimation',
      es: 'Animación Vectorial',
      fr: 'Animation Vectorielle',
      de: 'Vektoranimation',
    },
    ...
    'Fantasy Epic': {
      en: 'Fantasy Epic',
      sv: 'Fantasy-epos',
      es: 'Épica de Fantasía',
      fr: 'Épopée Fantastique',
      de: 'Fantasy-Epos',
    },
    ...
    'Vintage 1950s film': {
      en: 'Vintage 1950s Film',
      sv: 'Vintage 1950-talsfilm',
      es: 'Película Vintage 1950s',
      fr: 'Film Vintage des années 50',
      de: 'Vintage 1950er Film',
    },
    Minimalist: {
      en: 'Minimalist',
      sv: 'Minimalistisk',
...
export const getCameraMovements = (lang: Language): SelectOption[] => {
  const angles: { [key: string]: { [lang in Language]: string } } = {
    ...
    'First-person POV': {
      en: 'First Person POV',
      sv: 'Förstapersonsvy',
      es: 'Punto de Vista (POV)',
      fr: 'Vue Subjective (POV)',
      de: 'Ich-Perspektive (POV)',
    },
    'Dutch angle': {
      en: 'Dutch Angle',
      sv: 'Dutch Angle',
...
export const getCameraDistances = (lang: Language): SelectOption[] => {
  const distances: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Wide shot': {
      ...
      es: 'Plano General',
      fr: 'Plan Large',
      de: 'Weite Einstellung',
    },
    'Establishing shot': {
      en: 'Establishing Shot',
      sv: 'Etableringsbild',
      es: 'Plano de Establecimiento',
      fr: "Plan d'Ensemble",
      de: 'Totale Einstellung',
    },
  };
...
export const getLensTypes = (lang: Language): SelectOption[] => {
  const lenses: { [key: string]: { [lang in Language]: string } } = {
    'Standard prime lens': {
      en: 'Standard Prime Lens',
      sv: 'Standardobjektiv (Prime)',
      es: 'Lente Fijo Estándar',
      fr: 'Objectif à Focale Fixe Standard',
      de: 'Standard-Festbrennweite',
    },
    'Wide-angle lens': {
      en: 'Wide-angle Lens',
      sv: 'Vidvinkelobjektiv',
      es: 'Lente Gran Angular',
      fr: 'Objectif Grand Angle',
...
export const getVisualEffects = (lang: Language): SelectOption[] => {
  const effects: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Lens flare': {
      en: 'Lens Flare',
      sv: 'Linsöverstrålning',
      es: 'Destello de Lente',
      fr: "Reflet d'Objectif",
      de: 'Linsenreflexion',
    },
    'Anamorphic Lens Flare': {
      en: 'Anamorphic Lens Flare',
      sv: 'Anamorfisk Linsöverstrålning',
      es: 'Destello de Lente Anamórfico',
      fr: "Reflet d'Objectif Anamorphique",
      de: 'Anamorphotische Linsenreflexion',
    },
    'Volumetric Lighting': {
      en: 'Volumetric Lighting (God Rays)',
      sv: 'Volumetrisk belysning',
      es: 'Iluminación Volumétrica',
      fr: 'Éclairage Volumétrique',
      de: 'Volumetrische Beleuchtung',
    },
    'Double Exposure': {
      en: 'Double Exposure',
      sv: 'Dubbel Exponering',
      es: 'Doble Exposición',
      fr: 'Double Exposition',
      de: 'Doppelbelichtung',
    },
    'Dream-like haze': {
      en: 'Dream-like Haze',
      ...
      es: 'Neblina Onírica',
      fr: 'Brume Onirique',
      de: 'Traumartiger Dunst',
    },
    'Particle effects (e.g., dust, sparks)': {
      en: 'Particle Effects',
      sv: 'Partikeleffekter',
    ...
    'Light trails': {
      ...
      sv: 'Ljusspår',
      es: 'Estelas de Luz',
      fr: 'Traînées de Lumière',
      de: 'Lichtspuren',
    },
    '8mm film grain': {
      en: '8mm Film Grain',
      sv: '8mm filmkorn',
      es: 'Grano de Película de 8mm',
      fr: 'Grain de Film 8mm',
      de: '8mm Filmkörnung',
    },
    '16mm film grain': {
      en: '16mm Film Grain',
      sv: '16mm filmkorn',
      es: 'Grano de Película de 16mm',
      fr: 'Grain de Film 16mm',
      de: '16mm Filmkörnung',
    },
    '35mm film grain': {
      en: '35mm Film Grain',
      sv: '35mm filmkorn',
      es: 'Grano de Película de 35mm',
      fr: 'Grain de Film 35mm',
      de: '35mm Filmkörnung',
    },
    'Light leaks': {
      en: 'Light Leaks',
...
export const getColorPalettes = (lang: Language): SelectOption[] => {
  const palettes: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Complementary color scheme': {
      en: 'Complementary Color Scheme',
      sv: 'Komplementärt färgschema',
      es: 'Esquema de Color Complementario',
      fr: 'Schéma de Couleurs Complémentaire',
      de: 'Komplementäres Farbschema',
    },
    'Triadic color scheme': {
      en: 'Triadic Color Scheme',
      sv: 'Triadisk färgschema',
      es: 'Esquema de Color Triádico',
      fr: 'Schéma de Couleurs Triadique',
      de: 'Triadisches Farbschema',
    },
    'Analogous color scheme': {
      en: 'Analogous Color Scheme',
      sv: 'Analog färgschema',
      es: 'Esquema de Color Análogo',
      fr: 'Schéma de Couleurs Analogue',
      de: 'Analoges Farbschema',
    },
  };
...
export const getAnimationPresets = (lang: Language): SelectOption[] => {
  const presets: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Fade In/Out': {
      en: 'Fade In/Out',
      sv: 'Tona In/Ut',
      es: 'Aparecer/Desvanecer',
      fr: 'Fondu Entrant/Sortant',
      de: 'Ein-/Ausblenden',
    },
    Crossfade: {
      en: 'Crossfade',
    ...
    'Slide In/Out': {
      en: 'Slide In/Out',
      sv: 'Skjut In/Ut',
      es: 'Deslizar Entrada/Salida',
      fr: 'Glisser Entrant/Sortant',
      de: 'Herein-/Herausgleiten',
    },
  };
...
export const getVoiceStyles = (lang: Language): SelectOption[] => {
  const styles: { [key: string]: { [lang in Language]: string } } = {
    None: {
      en: 'None (Music/Ambiance only)',
      sv: 'Ingen (Endast musik/atmosfär)',
      es: 'Ninguna (Solo música/ambiente)',
      fr: 'Aucune (Musique/Ambiance uniquement)',
      de: 'Keine (Nur Musik/Atmosphäre)',
    },
    'Standard Narrator': {
      en: 'Standard Narrator',
      sv: 'Standardberättare',
      es: 'Narrador Estándar',
      fr: 'Narrateur Standard',
      de: 'Standard-Erzähler',
    },
    'Documentary Narrator': {
      en: 'Documentary Narrator',
      sv: 'Dokumentärberättare',
      es: 'Narrador de Documental',
      fr: 'Narrateur de Documentaire',
      de: 'Dokumentar-Erzähler',
    },
    'Character Monologue': {
      en: 'Character Monologue',
      sv: 'Karaktärsmonolog',
      es: 'Monólogo de Personaje',
      fr: 'Monologue de Personnage',
      de: 'Charakter-Monolog',
    },
    'High-Energy Announcer': {
      en: 'High-Energy Announcer',
      sv: 'Högenergi-utropare',
      es: 'Anunciante Energético',
      fr: 'Annonceur Énergique',
      de: 'Energiereicher Sprecher',
    },
    'Calm ASMR Voice': {
      en: 'Calm ASMR Voice',
      sv: 'Lugn ASMR-röst',
      es: 'Voz Relajante ASMR',
      fr: 'Voix Calme ASMR',
      de: 'Ruhige ASMR-Stimme',
    },
    'AI Assistant Voice': {
      en: 'AI Assistant Voice',
      sv: 'AI-assistentröst',
      es: 'Voz de Asistente de IA',
      fr: "Voix d'Assistant IA",
      de: 'KI-Assistenten-Stimme',
    },
    'Whispered ASMR': {
      en: 'Whispered ASMR (for relaxation)',
      sv: 'Viskande ASMR (för avslappning)',
      es: 'ASMR Susurrado (para relajación)',
      fr: 'ASMR Chuchoté (pour la relaxation)',
      de: 'Geflüstertes ASMR (zur Entspannung)',
    },
    'Deep Sci-Fi Robot': {
      en: 'Deep Sci-Fi Robot (for futuristic themes)',
      sv: 'Djup Sci-Fi Robot (för framtidsteman)',
      es: 'Robot de Sci-Fi Profundo (para temas futuristas)',
      fr: 'Robot de Sci-Fi Grave (pour thèmes futuristes)',
      de: 'Tiefe Sci-Fi-Roboterstimme (für futuristische Themen)',
    },
    'Excited Child': {
      en: 'Excited Child (for whimsical content)',
      sv: 'Exalterat Barn (för lekfullt innehåll)',
      es: 'Niño Emocionado (para contenido fantástico)',
      fr: 'Enfant Excité (pour contenu fantaisiste)',
      de: 'Aufgeregtes Kind (für skurrile Inhalte)',
    },
  };
  return Object.keys(styles).map((key) => ({ value: key, label: styles[key][lang] }));
};
...
export const getTimeOfDayOptions = (lang: Language): SelectOption[] => {
  const times: { [key: string]: { [lang in Language]: string } } = {
    Any: {
      en: 'Any / Not Specified',
      sv: 'Valfri / Ej specificerad',
      es: 'Cualquiera / No especificado',
      fr: 'Indifférent / Non spécifié',
      de: 'Beliebig / Nicht angegeben',
    },
...
export const getCreativityLevelOptions = (lang: Language): SelectOption[] => {
  const options: { [key: string]: { [lang in Language]: string } } = {
    Grounded: {
      en: 'Grounded in Reality',
      sv: 'Verklighetsförankrad',
      es: 'Basado en la Realidad',
      fr: 'Ancré dans la Réalité',
      de: 'Realitätsnah',
    },
    Balanced: {
      en: 'Balanced',
    ...
    Imaginative: {
      en: 'Highly Imaginative',
      sv: 'Mycket Fantasifull',
      es: 'Muy Imaginativo',
      fr: 'Très Imaginatif',
      de: 'Sehr Fantasievoll',
    },
  };
  return Object.keys(options).map((key) => ({ value: key, label: options[key][lang] }));
};
...
export const getCharacterEthnicityOptions = (lang: Language): SelectOption[] => {
  const ethnicities: { [key: string]: { [lang in Language]: string } } = {
    ...
    'African (General)': {
      ...
      sv: 'Afrikansk (Allmän)',
      es: 'Africana (General)',
      fr: 'Africaine (Général)',
      de: 'Afrikanisch (Allgemein)',
    },
    'Afro-Caribbean': {
      en: 'Afro-Caribbean',
      sv: 'Afro-karibisk',
    ...
    'Central African': {
      ...
      es: 'Centroafricana',
      fr: 'Centrafricaine',
      de: 'Zentralafrikanisch',
    },
    'East African': {
      en: 'East African',
      sv: 'Östafrikansk',
      es: 'Africana Oriental',
      fr: 'Est-Africaine',
      de: 'Ostafrikanisch',
    },
    'North African': {
    ...
    'Central Asian': {
      ...
      sv: 'Centralasiatisk',
      es: 'Asiática Central',
      fr: 'Asiatique Centrale',
      de: 'Zentralasiatisch',
    },
    'East Asian': {
      en: 'East Asian',
      sv: 'Östasiatisk',
      es: 'Asiática Oriental',
      fr: "Asiatique de l'Est",
      de: 'Ostasiatisch',
    },
    'South Asian': {
      en: 'South Asian',
    ...
    'Southeast Asian': {
      en: 'Southeast Asian',
      sv: 'Sydostasiatisk',
      es: 'Asiática del Sudeste',
      fr: 'Asiatique du Sud-Est',
      de: 'Südostasiatisch',
    },
    'European (General)': {
      en: 'European (General)',
      sv: 'Europeisk (Allmän)',
      es: 'Europea (General)',
      fr: 'Européenne (Général)',
      de: 'Europäisch (Allgemein)',
    },
    'Eastern European': {
      en: 'Eastern European',
      sv: 'Östeuropé',
      es: 'Europea del Este',
      fr: "Européenne de l'Est",
      de: 'Osteuropäisch',
    },
    'Northern European': {
    ...
    'Hispanic/Latin': {
      en: 'Hispanic/Latin',
      sv: 'Spansk/Latinamerikansk',
      es: 'Hispana/Latina',
      fr: 'Hispanique/Latine',
      de: 'Hispanisch/Lateinamerikanisch',
    },
    ...
    'Indigenous/Aboriginal': {
      en: 'Indigenous / Aboriginal',
      sv: 'Urfolk / Aborigin',
      es: 'Indígena / Aborigen',
      fr: 'Indigène / Aborigène',
      de: 'Indigen / Aboriginal',
    },
    'Native American': {
      en: 'Native American',
      sv: 'Amerikansk urinvånare',
      es: 'Nativa Americana',
      fr: 'Amérindienne',
      de: 'Amerikanischer Ureinwohner',
    },
    'Pacific Islander': {
      en: 'Pacific Islander',
      sv: 'Stillahavsöbor',
      es: 'Isleña del Pacífico',
      fr: 'Insulaire du Pacifique',
      de: 'Pazifischer Inselbewohner',
    },
    Polynesian: {
      en: 'Polynesian',
      sv: 'Polynesisk',
...
export const getCharacterClothings = (lang: Language): SelectOption[] => {
  const clothings: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Fantasy Armor': {
      en: 'Fantasy Armor',
      sv: 'Fantasirustning',
      es: 'Armadura de Fantasía',
      fr: 'Armure Fantastique',
      de: 'Fantasie-Rüstung',
    },
    'Sci-fi Suit': {
      en: 'Sci-fi Suit',
      sv: 'Sci-fi-dräkt',
      es: 'Traje de Ciencia Ficción',
      fr: 'Combinaison de Science-Fiction',
      de: 'Sci-Fi-Anzug',
    },
    'Cyberpunk Gear': {
      en: 'Cyberpunk Gear',
      sv: 'Cyberpunk-utrustning',
      es: 'Equipo Cyberpunk',
      fr: 'Équipement Cyberpunk',
      de: 'Cyberpunk-Ausrüstung',
    },
    'Post-apocalyptic': {
      en: 'Post-apocalyptic',
      sv: 'Postapokalyptisk',
      es: 'Post-apocalíptico',
    ...
    'Historical Garb': {
      en: 'Historical Garb',
      sv: 'Historisk dräkt',
      es: 'Atuendo Histórico',
      fr: 'Costume Historique',
      de: 'Historische Kleidung',
    },
    'Regal Attire': {
      en: 'Regal Attire',
      sv: 'Kunglig klädsel',
...
export const getCharacterAges = (lang: Language): SelectOption[] => {
  const ages: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Young Child (5-9)': {
      en: 'Young Child (5-9)',
      sv: 'Yngre Barn (5-9)',
      es: 'Niño/a Pequeño/a (5-9)',
      fr: 'Jeune Enfant (5-9)',
      de: 'Jüngeres Kind (5-9)',
    },
    'Preteen (10-12)': {
      en: 'Preteen (10-12)',
      sv: 'Förtonåring (10-12)',
      es: 'Preadolescente (10-12)',
      fr: 'Préadolescent (10-12)',
      de: 'Prä-Teenager (10-12)',
    },
    'Teenager (13-17)': {
      en: 'Teenager (13-17)',
      sv: 'Tonåring (13-17)',
      es: 'Adolescente (13-17)',
      fr: 'Adolescent (13-17)',
      de: 'Teenager (13-17)',
    },
    'Young Adult (18-25)': {
      en: 'Young Adult (18-25)',
      sv: 'Ung vuxen (18-25)',
      es: 'Adulto/a joven (18-25)',
      fr: 'Jeune adulte (18-25)',
      de: 'Junger Erwachsener (18-25)',
    },
    'Adult (26-45)': {
      en: 'Adult (26-45)',
      sv: 'Vuxen (26-45)',
      es: 'Adulto/a (26-45)',
      fr: 'Adulte (26-45)',
      de: 'Erwachsener (26-45)',
    },
    'Middle-aged (46-65)': {
      en: 'Middle-aged (46-65)',
      sv: 'Medelålders (46-65)',
      es: 'De mediana edad (46-65)',
      fr: "D'âge moyen (46-65)",
      de: 'Mittelalter (46-65)',
    },
    'Senior (66+)': {
      en: 'Senior (66+)',
      sv: 'Senior (66+)',
...
export const getCharacterPoses = (lang: Language): SelectOption[] => {
  const poses: { [key: string]: { [lang in Language]: string } } = {
    ...
    Waving: {
      en: 'Waving',
      sv: 'Vinkande',
      es: 'Saludando con la mano',
      fr: 'Faisant signe de la main',
      de: 'Winkend',
    },
  };
...
export const getCharacterSkinTones = (lang: Language): SelectOption[] => {
  const tones: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Dark, deep brown': {
      en: 'Dark, Deep Brown',
      sv: 'Mörk, djupbrun',
      es: 'Oscura, marrón profundo',
      fr: 'Foncé, brun profond',
      de: 'Dunkel, tiefbraun',
    },
    Black: { en: 'Black', sv: 'Svart', es: 'Negra', fr: 'Noir', de: 'Schwarz' },
    'Unusual (e.g., blue, green)': {
      en: 'Unusual (e.g., blue, green)',
      sv: 'Ovanlig (t.ex. blå, grön)',
      es: 'Inusual (p. ej., azul, verde)',
      fr: 'Inhabituel (ex: bleu, vert)',
      de: 'Ungewöhnlich (z.B. blau, grün)',
    },
  };
...
export const getAmbientSounds = (lang: Language): SelectOption[] => {
  const sounds: { [key: string]: { [lang in Language]: string } } = {
    None: {
      en: 'None / Music Only',
      sv: 'Inga / Endast Musik',
      es: 'Ninguno / Solo Música',
      fr: 'Aucun / Musique Uniquement',
      de: 'Keine / Nur Musik',
    },
    'City Ambience': {
      en: 'City Ambience',
      sv: 'Stadsatmosfär',
      es: 'Ambiente de Ciudad',
      fr: 'Ambiance de Ville',
      de: 'Stadt-Atmosphäre',
    },
    'Forest Sounds': {
      en: 'Forest Sounds',
    ...
    'Cozy Fireplace': {
      en: 'Cozy Fireplace',
      sv: 'Mysig brasa',
      es: 'Chimenea Acogedora',
      fr: 'Feu de Cheminée Confortable',
      de: 'Gemütlicher Kamin',
    },
    'Distant Celebration': {
      en: 'Distant Celebration',
      sv: 'Firande på avstånd',
      es: 'Celebración a lo Lejos',
      fr: 'Célébration Lointaine',
      de: 'Feier in der Ferne',
    },
    'Sci-fi Space Hum': {
      en: 'Sci-fi Space Hum',
      sv: 'Sci-fi Rymdbrum',
      es: 'Zumbido Espacial de Sci-fi',
      fr: 'Bourdonnement Spatial de Sci-fi',
      de: 'Sci-Fi-Weltraumsurren',
    },
    'Mechanical Hum': {
      en: 'Mechanical Hum',
      sv: 'Mekaniskt brum',
      es: 'Zumbido Mecánico',
      fr: 'Bourdonnement Mécanique',
      de: 'Mechanisches Summen',
    },
  };
...
export const getArchitecturalStyles = (lang: Language): SelectOption[] => {
  const styles: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Victorian Gothic': {
      en: 'Victorian Gothic',
      sv: 'Viktoriansk Gotik',
      es: 'Gótico Victoriano',
      fr: 'Gothique Victorien',
      de: 'Viktorianische Gotik',
    },
    Deconstructivist: {
      en: 'Deconstructivist',
      sv: 'Dekonstruktivistisk',
      es: 'Deconstructivista',
      fr: 'Déconstructiviste',
      de: 'Dekonstruktivistisch',
    },
    'Ancient Roman': {
      en: 'Ancient Roman',
      sv: 'Antik Romersk',
...
export const getLightingStyles = (lang: Language): SelectOption[] => {
  const styles: { [key: string]: { [lang in Language]: string } } = {
    ...
    'High-key': {
      en: 'High-key (bright, low contrast)',
      sv: 'High-key (ljus, låg kontrast)',
      es: 'Clave alta (brillante, bajo contraste)',
      fr: 'High-key (lumineux, faible contraste)',
      de: 'High-Key (hell, geringer Kontrast)',
    },
    'Low-key': {
      en: 'Low-key (dark, high contrast)',
      sv: 'Low-key (mörk, hög kontrast)',
      es: 'Clave baja (oscuro, alto contraste)',
      fr: 'Low-key (sombre, contraste élevé)',
      de: 'Low-Key (dunkel, hoher Kontrast)',
    },
    'Rembrandt lighting': {
      en: 'Rembrandt lighting (dramatic)',
      sv: 'Rembrandt-ljus (dramatiskt)',
      es: 'Iluminación Rembrandt (dramática)',
      fr: 'Éclairage Rembrandt (dramatique)',
      de: 'Rembrandt-Beleuchtung (dramatisch)',
    },
    'Backlit / Silhouette': {
      en: 'Backlit / Silhouette',
      sv: 'Bakgrundsbelyst / Silhuett',
      es: 'Contraluz / Silueta',
      fr: 'Contre-jour / Silhouette',
      de: 'Gegenlicht / Silhouette',
    },
    'Hard, direct sunlight': {
      en: 'Hard, direct sunlight',
      sv: 'Hårt, direkt solljus',
      es: 'Luz solar dura y directa',
      fr: 'Lumière du soleil dure et directe',
      de: 'Hartes, direktes Sonnenlicht',
    },
    'Soft, diffused light': {
      en: 'Soft, diffused light (overcast)',
      sv: 'Mjukt, spritt ljus (mulet)',
      es: 'Luz suave y difusa (nublado)',
      fr: 'Lumière douce et diffuse (couvert)',
      de: 'Weiches, diffuses Licht (bewölkt)',
    },
  };
  return Object.keys(styles).map((key) => ({ value: key, label: styles[key][lang] }));
};
...
export const getCompositionalGuides = (lang: Language): SelectOption[] => {
  const guides: { [key: string]: { [lang in Language]: string } } = {
    ...
    'Centered Subject': {
      ...
      es: 'Sujeto centrado',
      fr: 'Sujet centré',
      de: 'Zentriertes Motiv',
    },
    'Frame within a Frame': {
      en: 'Frame within a Frame',
      sv: 'Ram i en ram',
      es: 'Marco dentro de un marco',
      fr: 'Cadre dans le cadre',
      de: 'Rahmen im Rahmen',
    },
  };
  ...
  const prompts: Record<string, any> = {
    artisan: {
      en: {
        ...
        idea: 'A close-up, intimate portrait of a Renaissance painter creating a masterpiece.',
        prompt:
