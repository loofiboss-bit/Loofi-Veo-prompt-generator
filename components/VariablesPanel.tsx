            ...
            >
                <div className="p-5 border-b border-slate-700 bg-slate-800/50 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">
                            Use <code className="bg-slate-700 px-1 rounded text-cyan-400">{'{{KEY}}'}</code> in prompts to reuse these values.
                        </p>
                    </div>
                ...
                <div className="p-6 flex-grow overflow-y-auto">
                    ...
                    <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700 mb-6">
                        <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Add / Update Variable</h3>
                    ...
                    <div className="space-y-3">
                        {Object.entries(variables).length === 0 ? (
                            <p className="text-center text-slate-500 text-sm italic py-8">No variables defined.</p>
                        ) : (
                            Object.entries(variables).map(([key, value]) => (
                                <div key={key} className="flex items-center gap-3 p-3 bg-slate-800/60 rounded-lg border border-slate-700 hover:border-slate-600 group">
