...
const LyricSyncerModal: React.FC<LyricSyncerModalProps> = ({
  isOpen,
  onClose,
  lyricsText,
  audioUrl,
      ...
      <div className="w-full max-w-3xl flex flex-col h-[85vh] bg-slate-900 rounded-2xl border border-slate-700 shadow-2xl overflow-hidden">
        ...
        <div className="p-5 border-b border-slate-700 bg-slate-900 flex justify-between items-center z-10">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Tap <strong className="text-cyan-400">Spacebar</strong> at the start of each line.
            </p>
          </div>
        ...
        >
          ...
          {lines.map((line, idx) => {
            ...
            return (
              ...
              >
                <p
                  className={`text-2xl md:text-3xl font-bold ${isActive ? 'text-cyan-100' : 'text-slate-400'}`}
                >
                  {line.text}
                </p>
                {line.timestamp !== null && (
        ...
        <div className="p-4 bg-slate-900 border-t border-slate-700">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            >
              <div
                className={`w-3 h-3 rounded-full ${isPlaying ? 'bg-red-500 animate-pulse' : 'bg-slate-600'}`}
              />
