...
| F3  | **Cost/Quality Estimation**       | Per-prompt quality scoring (1–10) and cost estimation for Veo/Sora. Trade-off visualization. Batch optimization.                                               | `costEstimationService`    |
