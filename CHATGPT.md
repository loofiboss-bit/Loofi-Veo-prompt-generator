...
| Agent | Model | Use For |
|-------|-------|---------|
| project-coordinator | gpt-5 | Complex planning, multi-feature coordination, roadmap strategy |
| architecture-advisor | gpt-5-mini | Design decisions, patterns, structure review |
| backend-builder | gpt-5-mini | Service implementation, IndexedDB, business logic |
| frontend-integration-builder | gpt-5-mini | React components, Zustand stores, UI wiring |
| code-implementer | gpt-5-mini | Bug fixes, refactors, general code changes |
| test-writer | gpt-5-nano | Unit tests, test updates |
| release-planner | gpt-5-nano | Version bumps, changelog, release prep |

### Model Cost Rules

- **gpt-5**: Only for complex planning/coordination requiring deep reasoning
- **gpt-5-mini**: Default for all implementation work (best cost/quality ratio)
- **gpt-5-nano**: Simple, templated tasks (tests, docs, version bumps)
...
- Use gpt-5-nano for simple lookups and templated work.
...
4. Check relevant agent memory in `.chatgpt/agent-memory/`
