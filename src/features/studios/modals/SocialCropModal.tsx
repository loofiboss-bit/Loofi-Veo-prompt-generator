...
const SocialCropModal: React.FC<SocialCropModalProps> = ({ isOpen, onClose, videoUrl, onConfirm }) => {
                ...
                <div className="flex-grow flex items-center justify-center bg-black relative overflow-hidden select-none">
                    ...
                    >
                        ...
                        <div 
                            ...
                            style={{ 
                                left: `${currentX}px`, 
                                width: '177.77%' /* 16/9 ratio relative to 9/16 height container implies height is 100%, width is much larger. */
                    ...
                    <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
                        <video src={videoUrl} className="w-full h-full object-cover blur-xl" muted loop autoPlay />
                    </div>
                </div>
