...
### ⚙️ Performance & Stability (v1.5.0)
...
| Platform | Download |
|----------|----------|
| **Linux** | `Veo Prompt Generator-1.5.0.AppImage` |
| **Windows** | Coming soon |
| **macOS** | Coming soon |
...
./release/Veo\ Prompt\ Generator-1.5.0.AppImage
```
...
chmod +x "./release/Veo Prompt Generator-1.5.0.AppImage"
