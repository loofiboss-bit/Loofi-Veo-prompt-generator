...
const MOCK_VIDEOS: StockAsset[] = [
  {
    ...
    thumbnailUrl:
      'https://images.pexels.com/videos/3195640/free-video-3195640.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500',
  },
  {
    id: 'vid_2',
    type: 'video',
    ...
    thumbnailUrl:
      'https://images.pexels.com/videos/5737839/pexels-photo-5737839.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
  },
  {
    id: 'vid_3',
    type: 'video',
    ...
    thumbnailUrl:
      'https://images.pexels.com/videos/855018/free-video-855018.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500',
  },
  {
    id: 'vid_4',
    type: 'video',
    ...
    thumbnailUrl:
      'https://images.pexels.com/videos/4782135/pexels-photo-4782135.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
  },
  {
    id: 'vid_5',
    type: 'video',
    ...
    thumbnailUrl:
      'https://images.pexels.com/videos/2603664/free-video-2603664.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500',
  },
  {
    id: 'vid_6',
    type: 'video',
    ...
    thumbnailUrl:
      'https://images.pexels.com/videos/3053785/free-video-3053785.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500',
  },
];
...
export const searchStockVideo = async (query: string): Promise<StockAsset[]> => {
  ...
  return MOCK_VIDEOS.filter(
    (v) => !q || v.title.toLowerCase().includes(q) || v.author.toLowerCase().includes(q),
  );
};
