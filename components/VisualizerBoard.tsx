...
const VisualizerBoard: React.FC<VisualizerBoardProps> = ({ promptState, label }) => {
  ...
  const backgroundStyle = useMemo(() => {
    ...
    } else if (promptState.lightingStyle.includes('Neon') || promptState.visualEffect.includes('Neon')) {
        gradient = 'linear-gradient(to right, #0f0c29, #302b63, #24243e)';
    }

    return { background: gradient };
  }, [promptState.timeOfDay, promptState.lightingStyle, promptState.artStyle, promptState.visualEffect]);
