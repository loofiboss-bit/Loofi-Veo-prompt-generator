...
const CharacterTab: React.FC<CharacterTabProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <TextAreaInput
        label={t('prompt:labelCharacterActions')}
        name="characterActions"
        value={promptState.characterActions}
        onChange={handleInputChange}
        placeholder={t('prompt:placeholderCharacterActions')}
        rows={3}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <SelectInput
          label={t('prompt:labelCharacterArchetype')}
        ...
        <div className="grid grid-cols-2 gap-4">
          <SelectInput
            label={t('prompt:labelCharacterAge')}
            name="characterAge"
          ...
          />
          <SelectInput
            label={t('prompt:labelCharacterGender')}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <SelectInput
          label={t('prompt:labelCharacterMood')}
          name="characterMood"
        ...
        />
        <SelectInput
          label={t('prompt:labelCharacterPose')}
          name="characterPose"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <SelectInput
          label={t('prompt:labelCharacterEthnicity')}
        ...
        />
        <SelectInput
          label={t('prompt:labelCharacterSkinTone')}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <TextAreaInput
          label={t('prompt:labelCharacterSpecificClothing')}
          name="characterSpecificClothing"
          value={promptState.characterSpecificClothing}
          onChange={handleInputChange}
          placeholder={t('prompt:placeholderCharacterSpecificClothing')}
          rows={2}
        ...
        />
        <TextAreaInput
          label={t('prompt:labelCharacterAccessories')}
          name="characterAccessories"
          value={promptState.characterAccessories}
          onChange={handleInputChange}
          placeholder={t('prompt:placeholderCharacterAccessories')}
          rows={2}
