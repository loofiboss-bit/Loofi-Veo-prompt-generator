...
const GenerativeCanvasModal: React.FC<GenerativeCanvasModalProps> = ({ 
    isOpen, onClose, conceptImageUrl, onGenerateFill 
}) => {
    ...
    return (
        <div className="fixed inset-0 bg-slate-950/95 z-[200] flex flex-col items-center justify-center p-4 backdrop-blur-sm">
            ...
            {/* Canvas Container */}
            <div ref={containerRef} className="relative w-full max-w-5xl flex-grow flex items-center justify-center overflow-hidden my-16 bg-[url('https://www.transparenttextures.com/patterns/dark-matter.png')] bg-slate-900 border-y border-slate-800">
                <canvas
                    ref={canvasRef}
