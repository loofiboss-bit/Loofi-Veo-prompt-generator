...
const errorMessageMatchers: { type: ApiErrorType; tests: (string | RegExp)[] }[] = [
  {
    type: ApiErrorType.LocationNotSupported,
    tests: ['location', 'region', 'not supported', 'country', 'precondition_failed'],
  },
  {
    type: ApiErrorType.ResourceNotFound,
    tests: ['404', 'not found', 'model not found', 'resource not found'],
  },
  {
  ...
  },
  {
    ...
    tests: ['quota', 'insufficient_quota', 'billing', 'plan', '402'],
  },
  {
    type: ApiErrorType.RateLimitExceeded,
    tests: ['rate limit', '429', 'resource_exhausted', 'too many requests', 'overloaded'],
  },
  {
  ...
  },
  {
    ...
    tests: ['503', 'capacity', 'unavailable', 'maintenance'],
  },
  {
    type: ApiErrorType.BadRequest,
    tests: ['400', 'bad request', 'invalid argument', 'precondition', 'malformed', 'empty prompt'],
  },
  {
    type: ApiErrorType.ServerError,
    tests: ['500', '502', '504', 'internal error', 'server error', 'upstream'],
  },
  {
