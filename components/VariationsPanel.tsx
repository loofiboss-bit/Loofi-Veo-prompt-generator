...
import { ToastMessage, PromptVariation } from '../types';
                        ...
                        <>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {variations.map((variation, index) => (
                                    <div key={index} className="bg-slate-800/60 p-4 rounded-xl border border-slate-700 flex flex-col hover:border-slate-600 transition-all shadow-lg hover:shadow-cyan-900/10">
                                        <div className="flex-grow">
                                            ...
                                            <p className="text-sm text-slate-300 leading-relaxed whitespace-pre-wrap">{variation.prompt}</p>
                                        </div>
                                        <div className="mt-4 pt-4 border-t border-slate-700/50 flex justify-between items-center">
                                            <label htmlFor={`variation-check-${index}`} className="flex items-center space-x-2 text-sm text-slate-400 cursor-pointer hover:text-slate-200 transition-colors">
                                                <input
                                                    type="checkbox"
                                    ...
                                    >
                                        {isCombining ? (
                                            ...
                                            <>
                                                ...
                                                <span>{uiStrings.combine} ({selectedVariations.length})</span>
                                            </>
                                        )}
                                    </button>
                                </div>
