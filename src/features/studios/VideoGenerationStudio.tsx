                    ...
                    <div className="lg:col-span-3 flex flex-col h-full min-h-[400px]">
                        ...
                        <div className="flex space-x-1 mb-4 bg-slate-800/50 p-1 rounded-lg self-start">
                            <button
                                ...
                                className={`px-4 py-1.5 text-xs font-semibold rounded-md transition-all ${activeTab === 'results' ? 'bg-cyan-600 text-white shadow-sm' : 'text-slate-400 hover:text-white'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-4 py-1.5 text-xs font-semibold rounded-md transition-all ${activeTab === 'queue' ? 'bg-yellow-600 text-white shadow-sm' : 'text-slate-400 hover:text-white'
                                    }`}
                            >
