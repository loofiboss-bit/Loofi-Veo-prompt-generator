...
import { historyService, type HistoryEntry, type HistoryFilter, type HistoryStats } from '@core/services/historyService';
...
interface HistoryStore {
    ...
    addEntry: (entry: Omit<HistoryEntry, 'id' | 'timestamp' | 'version'>) => Promise<HistoryEntry | null>;
