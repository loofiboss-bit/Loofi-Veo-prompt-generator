...
import { calculateSubjectCenter } from '../services/smartCropService';
            ...
            <div className="bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl w-full max-w-4xl flex flex-col overflow-hidden max-h-[90vh]">
                    ...
                    >
                        ...
                        {isAnalyzing && (
                            <div className="absolute inset-0 flex flex-col items-center justify-center z-50">
                                <Icon name="video-analysis" className="w-12 h-12 text-cyan-400 animate-pulse mb-4" />
                ...
                <div className="p-4 bg-slate-800/30 flex justify-between items-center">
                    <div className="flex gap-2">
                        ...
                        >
                            {isAnalyzing ? <Icon name="spinner" className="w-4 h-4 animate-spin" /> : <Icon name="video-analysis" className="w-4 h-4" />}
                            Auto-Track Subject
                        </button>
                    </div>
