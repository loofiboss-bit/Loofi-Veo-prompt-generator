...
const SpatialPanner: React.FC<SpatialPannerProps> = ({ x, z, onChange, label = "Spatial Panner" }) => {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            >
                ...
                {/* Labels */}
                <span className="absolute top-1 left-1/2 -translate-x-1/2 text-[8px] text-slate-500 font-bold pointer-events-none">FRONT</span>
                <span className="absolute bottom-1 left-1/2 -translate-x-1/2 text-[8px] text-slate-500 font-bold pointer-events-none">BACK</span>
                <span className="absolute left-1 top-1/2 -translate-y-1/2 text-[8px] text-slate-500 font-bold pointer-events-none -rotate-90">LEFT</span>
                <span className="absolute right-1 top-1/2 -translate-y-1/2 text-[8px] text-slate-500 font-bold pointer-events-none rotate-90">RIGHT</span>
