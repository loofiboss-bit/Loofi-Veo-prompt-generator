        ...
        case 'save':
            return (
                <svg
                    ...
                    {...commonProps}
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 13.5l3 3m0 0l3-3m-3 3v-6m1.06-4.19l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44z" />
                </svg>
            );
        case 'lightbulb':
            return (
        ...
        case 'music':
            return (
                <svg
                    ...
                    {...commonProps}
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l2.31-.66a2.25 2.25 0 001.632-2.163zm0 0V7.5A2.25 2.25 0 0013.5 3H9.75A2.25 2.25 0 007.5 5.25v1.5" />
                </svg>
            );
        case 'search':
            return (
        ...
        case 'chat':
            return (
                <svg
                    ...
                    {...commonProps}
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72h-1.981c-1.136 0-1.98-1.057-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097M16.5 6.75v3.75m0 0l-3-3m3 3l3-3M6.75 6.75v3.75m0 0l-3-3m3 3l3-3" />
                </svg>
            );
        case 'video-analysis':
            return (
                <svg
                    ...
                    {...commonProps}
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="m15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M12 18.75H4.5a2.25 2.25 0 0 1-2.25-2.25v-9A2.25 2.25 0 0 1 4.5 5.25H9.75" />
        ...
        case 'dna':
            return (
                <svg
                    ...
                    {...commonProps}
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-6.721M12 2.25V4.5m5.834.166-1.591 1.591M20.25 10.5H18M7.757 14.743l-1.59 1.59M6 10.5H3.75m4.007-4.243-1.59-1.59" />
