...
interface ProjectStore {
    ...
    createProject: (data: { name: string; description?: string; tags?: string[] }) => Promise<Project | null>;
    loadProject: (id: string) => Promise<Project | null>;
    updateProject: (id: string, updates: Partial<Omit<Project, 'id' | 'createdAt'>>) => Promise<boolean>;
