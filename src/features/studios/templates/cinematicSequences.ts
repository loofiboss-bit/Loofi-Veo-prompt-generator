...
export const CINEMATIC_SEQUENCES: SequenceTemplate[] = [
  {
    ...
    shots: [
      ...
      { action: '{char1} and {char2} continue the exchange', camera: 'Two Shot', focusChar: 'both' },
    ],
  },
  {
    id: 'chase-sequence',
    ...
    requiredCharacters: 2,
    shots: [
      { action: '{char1} runs through the environment, looking back in fear', camera: 'Tracking Shot', focusChar: 1 },
      { action: '{char2} pursues with determination', camera: 'Handheld Follow', focusChar: 2 },
      { action: 'Wide view of both characters racing through {context}', camera: 'Crane Shot', focusChar: 'both' },
  ...
  },
  {
    ...
    shots: [
      { action: '{char1} approaches cautiously, sensing something about {context}', camera: 'Slow Push In', focusChar: 1 },
      { action: 'Close-up of {char1} face showing dawning realization', camera: 'Extreme Close-Up', focusChar: 1 },
      { action: 'The full scope of {context} is revealed', camera: 'Wide Reveal Shot', focusChar: 1 },
    ],
  },
  {
    id: 'confrontation',
    ...
    requiredCharacters: 2,
    shots: [
      { action: '{char1} and {char2} face each other over {context}', camera: 'Wide Shot', focusChar: 'both' },
      { action: '{char1} makes an aggressive statement or gesture', camera: 'Over-the-Shoulder', focusChar: 1 },
      { action: '{char2} responds with defiance', camera: 'Over-the-Shoulder', focusChar: 2 },
      { action: 'Tension peaks between {char1} and {char2}', camera: 'Dutch Angle Close-Up', focusChar: 'both' },
    ],
  },
  {
    id: 'montage',
    ...
    requiredCharacters: 1,
    shots: [
      { action: '{char1} begins preparing for {context}', camera: 'Wide Establishing', focusChar: 1 },
      ...
      { action: '{char1} achieves a breakthrough moment', camera: 'Low Angle Hero Shot', focusChar: 1 },
      { action: '{char1} stands confident, transformed by {context}', camera: 'Silhouette Wide', focusChar: 1 },
    ],
  },
];
