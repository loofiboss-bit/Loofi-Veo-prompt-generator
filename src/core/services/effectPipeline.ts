...
const colorDistance = (
  ...
  return Math.sqrt((r2 - r1) * (r2 - r1) + (g2 - g1) * (g2 - g1) + (b2 - b1) * (b2 - b1)) / 441.67; // Normalize to 0-1 (approx sqrt(255^2 * 3))
};
...
export const applyEffects = (
  ...
  const chromaEffect = effects.find((e) => e.isEnabled && e.type === 'chroma') as
    | ChromaKeyEffect
    | undefined;
