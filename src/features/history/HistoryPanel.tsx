                            ...
                            <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1 sm:pb-0">
                                {(['all', 'veo', 'sora'] as const).map(filter => (
                                    <button
                                        ...
                                        className={`px-3 py-1.5 text-xs font-medium rounded-full border transition-all capitalize whitespace-nowrap ${activeFilter === filter
                                                ? (filter === 'sora'
                                        ...
                                        <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                                            ...
                                            <div className="flex items-center w-full sm:w-auto gap-2 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-700/50 self-start sm:self-center">
                                                <button
                                                    ...
                                                    className={`flex-1 sm:flex-none px-4 py-2 text-xs font-semibold rounded-md transition-all duration-300 flex items-center justify-center gap-2 ${applyingId === entry.id
