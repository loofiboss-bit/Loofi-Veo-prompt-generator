...
export async function initAutosave(config: AutosaveConfig): Promise<boolean> {
    try {
        ...
        logger.info('Autosave system initialized', { wasCrashed, config });
        return wasCrashed;
    } catch (error) {
...
async function performAutosave(data: any): Promise<void> {
    try {
        ...
        logger.debug('Autosave completed', { timestamp: snapshot.timestamp });
    } catch (error) {
...
export async function saveSnapshot(data: any, label?: string): Promise<void> {
    try {
        ...
        logger.info('Manual snapshot saved', { label });
    } catch (error) {
...
export async function getLatestAutosave(): Promise<AutosaveSnapshot | null> {
    try {
        ...
        logger.error('Failed to get latest autosave', error);
        return null;
    }
}
...
export async function getAutosaveHistory(): Promise<AutosaveSnapshot[]> {
    try {
        ...
        logger.error('Failed to get autosave history', error);
        return [];
    }
}
...
export async function exportAutosaveData(): Promise<string> {
    try {
        ...
        logger.error('Failed to export autosave data', error);
        throw error;
    }
}
