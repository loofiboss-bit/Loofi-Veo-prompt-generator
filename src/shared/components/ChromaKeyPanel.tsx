...
const ChromaKeyPanel: React.FC<ChromaKeyPanelProps> = ({ config, onChange, onReset, onPickColor, isPicking }) => {
    return (
                    ...
                    <div className="space-y-4 animate-fade-in-up">
                        <div className="flex items-end gap-3">
                            <div className="flex-grow">
                                <label className="text-[10px] uppercase font-bold text-slate-500 mb-1 block">Key Color</label>
