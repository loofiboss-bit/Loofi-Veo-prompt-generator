            ...
            >
              ...
              <div className="grid grid-cols-5 gap-2">
                {ASPECT_RATIOS.map((ratio) => (
                  ...
                  >
                    <div
                      className={`${ratio.width} ${ratio.height} border-2 rounded-sm mb-1 ${aspectRatio === ratio.value ? 'border-cyan-400 bg-cyan-400/20' : 'border-slate-500'}`}
                    />
                    <span
                      className={`text-[10px] ${aspectRatio === ratio.value ? 'text-cyan-300 font-bold' : 'text-slate-400'}`}
                    >
                      {ratio.value}
                    </span>
                  </button>
            ...
            <div className="border border-slate-700 rounded-xl bg-slate-900/30 overflow-hidden">
              ...
              {showAdvanced && (
                <div className="p-4 space-y-4 border-t border-slate-700/50 animate-fade-in-up">
                  ...
                  <div
                    className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${!!baseImage ? 'opacity-50 pointer-events-none' : ''}`}
                  >
                    <div>
