import { VolumeKeyframe } from '@core/types';
  ...
  for (let i = 0; i < energies.length; i++) {
    ...
    if (instantEnergy > localAverage * threshold && instantEnergy > 0.01) {
      ...
      if (
        ...
        timeSeconds - beatTimestamps[beatTimestamps.length - 1] > minPeakDistance
      ) {
