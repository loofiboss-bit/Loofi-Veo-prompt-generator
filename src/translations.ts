...
export const appUIStrings: any = {
    en: {
        ...
        labelAudioUpload: "Reference Audio (Optional)",
        placeholderAudioUpload: "Upload MP3/WAV to inspire the prompt",
        ...
        toastAudioAnalyzed: "Audio analyzed! Idea updated with mood.",
        ...
        tooltips: {
            ...
            audioUpload: "Upload a reference audio file (music, ambience, etc.). The AI will analyze it to influence the prompt's mood and pacing.",
